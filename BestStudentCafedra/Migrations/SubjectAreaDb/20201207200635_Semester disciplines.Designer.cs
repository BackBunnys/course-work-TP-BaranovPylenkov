...
namespace BestStudentCafedra.Migrations.SubjectAreaDb
{
    ...
    [Migration("20201207200635_Semester disciplines")]
    partial class Semesterdisciplines
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BestStudentCafedra.Models.EventLog", b =>
                {
                    ...
                    b.Property<int>("SchedulePlanEventId")
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "SchedulePlanEventId" }, "schedule_plan_event_id");
            ...
            modelBuilder.Entity("BestStudentCafedra.Models.EventLog", b =>
                {
                    ...
                    b.HasOne("BestStudentCafedra.Models.SchedulePlanEvent", "SchedulePlanEvent")
                        .WithMany("EventLogs")
                        .HasForeignKey("SchedulePlanEventId")
                        .HasConstraintName("event_log_ibfk_2")
                        .IsRequired();

                    b.Navigation("GraduationWork");

                    b.Navigation("SchedulePlanEvent");
                });
            ...
            modelBuilder.Entity("BestStudentCafedra.Models.SchedulePlan", b =>
                {
                    b.Navigation("SchedulePlanEvents");
                });
